...
#define SQOFFBOARD(sq) (Sq120ToSq64[(sq)] == 65)
#define SqOnBoard(sq)  (!SQOFFBOARD(sq))

/* Move encoding (28 bits used):
...
#define MFLAGCAP  0x7C000    /* any capture    */
#define MFLAGPROM 0xF00000   /* any promotion  */

#define MOVE(f,t,ca,pro,fl) ( (f) | ((t)<<7) | ((ca)<<14) | ((pro)<<20) | (fl) )
#define NOMOVE 0

/* Validation helpers */
#define SideValid(s)        ( (s)==WHITE || (s)==BLACK )
#define FileRankValid(fr)   ( (fr)>=0 && (fr)<=7 )
#define PieceValidEmpty(p)  ( (p)>=EMPTY && (p)<=bK )
#define PieceValid(p)       ( (p)>=wP && (p)<=bK )
